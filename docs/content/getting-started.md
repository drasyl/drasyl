...
```java
Gradle : compile "org.drasyl:drasyl-core:0.3.0-SNAPSHOT" // build.gradle 
   Ivy : <dependency org="org.drasyl" name="drasyl-core" rev="0.3.0-SNAPSHOT" conf="build" /> // ivy.xml
   SBT : libraryDependencies += "org.drasyl" % "drasyl-core" % "0.3.0-SNAPSHOT" // build.sbt
```
