...
```java
Gradle : compile "org.drasyl:drasyl-core:0.4.1" // build.gradle 
   Ivy : <dependency org="org.drasyl" name="drasyl-core" rev="0.4.1" conf="build" /> // ivy.xml
   SBT : libraryDependencies += "org.drasyl" % "drasyl-core" % "0.4.1" // build.sbt
```
