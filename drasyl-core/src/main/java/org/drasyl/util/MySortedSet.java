 ...
 * {@link Comparable#compareTo(Object)} returns {@code 0}. In contrast, {@link MySortedSet} uses
 * {@link Object#hashCode()} and {@link Object#equals(Object)} to determine equality.
 * <p>
 * <strong>Here an example which cannot be handled by {@link java.util.TreeSet} but from
 * {@link MySortedSet}:</strong><br>Assume the DAO class {@code Person} with attributes {@code name}
 * and {@code height}. Now assume a data structure containing a set of {@code Person}s where each
 * {@code name} should be unique, and the elements should be sorted by {@code height}.
 * <p>
...
public class MySortedSet<E> implements SortedSet<E> {
    ...
    public MySortedSet(final int initialCapacity) {
     ...
     */
    @SuppressWarnings("unused")
    public MySortedSet(final Comparator<? super E> comparator) {
        internalSet = new HashSet<>();
        internalList = new ArrayList<>();
