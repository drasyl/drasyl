...
public class RelayServerConfig {
    ...
    private static final String IDLE_RETRIES = "relay.idle.retries";
    private static final String IDLE_TIMEOUT = "relay.idle.timeout";
    private static final String RELAY_FLUSH_BUFFER_SIZE = "relay.flush_buffer_size";
    private static final String RELAY_SSL_ENABLED = "relay.ssl.enabled";
    private static final String RELAY_SSL_PROTOCOLS = "relay.ssl.protocols";
    private static final String RELAY_DEBUGGING = "relay.debugging";
    private static final String RELAY_MONITORING_WEBSOCKET_PATH = "relay.monitoring.websocket_path";
    private static final String RELAY_MONITORING_PORT = "relay.monitoring.port";
    private static final String RELAY_MONITORING_TOKEN = "relay.monitoring.token";
    private static final String RELAY_MONITORING_ENABLED = "relay.monitoring.enabled";
    private static final String RELAY_MAX_HANDOFF_TIMEOUT = "relay.max_handoff_timeout";
    private static final String RELAY_DEFAULT_P2P_TIMEOUT = "relay.default_p2p_timeout";
    private static final String RELAY_MAX_HANDSHAKE_TIMEOUT = "relay.max_handshake_timeout";
    private static final String RELAY_DEFAULT_FUTURE_TIMEOUT = "relay.default_future_timeout";
    private static final String RELAY_MAX_HOP_COUNT = "relay.max_hop_count";
    private static final String RELAY_MSG_BUCKET_LIMIT = "relay.msg_bucket_limit";
    private static final String RELAY_CONNECTION_TRIES = "relay.connection_tries";
    private static final String RELAY_INIT_PEER_LIST = "relay.init_peer_list";
    private static final String RELAY_ENTRYPOINT = "relay.entrypoint";
    private static final String RELAY_UID = "relay.UID";
    private static final String RELAY_DEFAULT_CHANNEL = "relay.default_channel";
    private static final String RELAY_USER_AGENT = "relay.user-agent";
    private static final String RELAY_MONITORING_DEAD_CLIENTS_SAVING_TIME = "relay.monitoring.dead_clients_saving_time";
    private static final String RELAY_CHANNEL_INITIALIZER = "relay.channel_initializer";
    private static final String RELAY_MAX_CONTENT_LENGTH = "relay.max_content_length";
