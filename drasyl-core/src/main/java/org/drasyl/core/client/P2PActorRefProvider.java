...
import org.drasyl.core.client.transport.P2PTransportTerminator;
import scala.*;
...
public class P2PActorRefProvider implements ActorRefProvider {
    ...
    public void init(ActorSystemImpl system) {
        ...
        transportTerminator.tell(new P2PTransportTerminator.Internals(transport), ActorRef.noSender());
