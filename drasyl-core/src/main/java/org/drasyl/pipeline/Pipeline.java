 ...
 * operation such as {@link org.drasyl.messenger.MessageSink#send(RelayableMessage)}. If an inbound
 * event goes beyond the top handler, it is passed to the application.
 * <p>
 ...
 * requests. If an outbound event goes beyond the bottom handler, it is handled by the {@link
 * org.drasyl.messenger.Messenger#send(RelayableMessage)} which performs the actual output
 * operation.
 * <p>
