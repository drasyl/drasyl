...
public class UpnpIgdPortMappingTest {
    ...
    class HandleMessage {
        ...
        void shouldHandleIncomingSsdpPacket(@Mock final UpnpIgdUtil upnpIgdUtil,
            ...
            try {
                final Set<URI> ssdpServices = new HashSet<>();
                byteBuf = Unpooled.wrappedBuffer(HexUtil.fromString(""));
                when(msg.getContent()).thenReturn(byteBuf);
                when(msg.getSender()).thenReturn(SSDP_MULTICAST_ADDRESS);
                when(msg.refCnt()).thenReturn(1);
                new UpnpIgdPortMapping(new AtomicBoolean(true), upnpIgdUtil, ssdpServices, null, 0, timeoutGuard, ssdpDiscoverTask, refreshTask, upnpService, onFailure).handleMessage(ctx, msg);
