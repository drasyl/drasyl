...
class ChunkedMessageOutputTest {
    ...
    void equalsAndHashCodeTest() {
        ...
        final ChunkedMessageOutput output3 = new ChunkedMessageOutput(ctx, sender, recipient, contentLength, checksum, MessageId.of("412176952b5b81fd13f84a7c"), maxContentLength, payload, progress, removeAction);
