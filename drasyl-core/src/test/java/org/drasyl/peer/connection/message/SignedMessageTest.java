...
class SignedMessageTest {
    ...
    class JsonSerialization {
        ...
        void shouldSerializeToCorrectJson() throws IOException, CryptoException {
            final SignedMessage message = new SignedMessage(
                    networkId,
    ...
    class Equals {
        ...
        void shouldReturnTrue() throws CryptoException {
            final PingMessage message = new PingMessage(networkId, sender, proofOfWork, recipient);
