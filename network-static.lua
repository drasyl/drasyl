...
net.add_link(members[1], members[2])
net.add_link(members[1], members[3])
net.add_link(members[1], members[4])
net.add_link(members[1], members[5])
net.add_link(members[1], members[6])
