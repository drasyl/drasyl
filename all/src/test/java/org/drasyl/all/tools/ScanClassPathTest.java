...
class ScanClassPathTest {
    ...
    void test() throws IOException, ClassNotFoundException {
        ...
        assertThat(classes, contains(SomeTestClass.class.getName()));

        classes.forEach(s -> {
            Pair<Class, MyAnnotation> pair = scp.loadClassAndGetAnnotation(s, MyAnnotation.class);
            assertThat(pair.left(), is(SomeTestClass.class));
            assertThat(pair.right(), is(instanceOf(MyAnnotation.class)));
        });
    }
