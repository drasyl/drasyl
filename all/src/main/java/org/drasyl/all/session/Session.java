...
public class Session {
    ...
    private final IPAddress targetSystem;
    ...
    Session(ConcurrentHashMap<String, Pair<Class<? extends Message>, CompletableFuture<Message>>> futures,
            ...
            AtomicLong futuresTimeouted, IPAddress targetSystem, boolean isTerminated, boolean isClosed) {
     ...
     */
    public Session(Channel channel, IPAddress targetSystem, SessionUID uid, SessionUID myRelayUID,
     ...
     */
    public IPAddress getTargetSystem() {
        return targetSystem;
    }
