 ...
 * left this specific relay server.
 */
public class ClientLeave extends P2PMessage {
    ...
    /**
     * Creates a new {@link ClientLeave} message.
     * 
     * @param clientUID the session UID of the client
     */
    public ClientLeave(SessionUID clientUID) {
    ...
    public boolean equals(Object o) {
        if (o instanceof ClientLeave) {
            ClientLeave m2 = (ClientLeave) o;
