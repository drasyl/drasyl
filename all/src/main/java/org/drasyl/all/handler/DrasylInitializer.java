 ...
 */
public class DrasylInitializer extends DefaultSessionInitializer {
    private static final Logger LOG = LoggerFactory.getLogger(DrasylInitializer.class);
    private final CircularFifoQueue<String> outboundMessagesQueue;
    private final Drasyl relay;

    public DrasylInitializer(Drasyl relay) {
