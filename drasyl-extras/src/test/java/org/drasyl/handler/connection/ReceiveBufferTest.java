...
class ReceiveBufferTest {
    ...
    class Receive {
        ...
        void test(@Mock final Channel channel,
            ...
            final TransmissionControlBlock tcb = new TransmissionControlBlock(ReliableTransportConfig.newBuilder().build(), 100, 0, 0, 100, 918402327, 0, sendBuffer, new RetransmissionQueue(), buffer, 0, 0, false);
        ...
        void preventMemoryDeadlock(@Mock final Channel channel,
            ...
            final TransmissionControlBlock tcb = new TransmissionControlBlock(ReliableTransportConfig.newBuilder().build(), 100, 0, 0, 100, 0, 0, sendBuffer, new RetransmissionQueue(), buffer, 0, 0, false);
        ...
        class InOrderWithNoOverlappingSegments {
            ...
            void receiveSegmentsInOrder(@Mock final Channel channel,
                ...
                final TransmissionControlBlock tcb = new TransmissionControlBlock(ReliableTransportConfig.newBuilder().build(), 100, 100, 0, 100, 0, 0, sendBuffer, new RetransmissionQueue(), new ReceiveBuffer(channel), 0, 0, false);
                final ReceiveBuffer buffer = new ReceiveBuffer(channel);
        ...
        class InOrdnerButOverlappingSegments {
            ...
            void receiveSegmentWithTailBeingDuplicate(@Mock final Channel channel,
                ...
                final TransmissionControlBlock tcb = new TransmissionControlBlock(ReliableTransportConfig.newBuilder().build(), 100, 100, 0, 100, 0, 0, sendBuffer, new RetransmissionQueue(), buffer, 0, 0, false);
        ...
        class OutOfOrderWithOverlappingSegments {
            ...
            void receiveSegmentWithCenterBeingDuplicate(@Mock final Channel channel,
                ...
                final ReceiveBuffer buffer = new ReceiveBuffer(channel, head, null, 0, 60);
                final TransmissionControlBlock tcb = new TransmissionControlBlock(ReliableTransportConfig.newBuilder().build(), 100, 0, 0, 100, 10, 0, sendBuffer, new RetransmissionQueue(), buffer, 0, 0, false);
        ...
        class OutOfWindowSegments {
            ...
            void receiveSegmentThatIsPartiallyBeforeTheReceiveWindow(@Mock final Channel channel,
                                                                     ...
                                                                     @Mock final SendBuffer sendBuffer) {
                final ReceiveBuffer buffer = new ReceiveBuffer(channel);
                final TransmissionControlBlock tcb = new TransmissionControlBlock(ReliableTransportConfig.newBuilder().build(), 100, 100, 0, 100, 60, 0, sendBuffer, new RetransmissionQueue(), buffer, 0, 0, false);
            ...
            void receiveSegmentThatIsFullyBeforeTheReceiveWindow(@Mock final Channel channel,
                ...
                final TransmissionControlBlock tcb = new TransmissionControlBlock(ReliableTransportConfig.newBuilder().build(), 100, 0, 0, 100, 100, 0, sendBuffer, new RetransmissionQueue(), buffer, 0, 0, false);
