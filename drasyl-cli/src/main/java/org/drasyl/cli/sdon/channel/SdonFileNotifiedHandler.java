...
class SdonFileNotifiedHandler extends ChannelInboundHandlerAdapter {
    private static final Logger LOG = LoggerFactory.getLogger(SdonFileNotifiedHandler.class);
